...
public class WeatherService {
    ...
    public WeatherService(@Value("${app.openweather.api-key}") String apiKey) {
        this.apiKey = apiKey;
        this.http = HttpClient.newHttpClient();
    }

    public record WeatherData(String city, double tempCelsius, int humidity,
            String description, double feelsLike, double windSpeed) {
    }

    public record ForecastSlot(String time, double tempCelsius, String description,
